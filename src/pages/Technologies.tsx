...
const Technologies: Component = () => {
  return (
    <>
      <Title>Technologies - Sylphx</Title>
      <Meta
        name="description"
        content="Built with TypeScript, MCP, React, Flutter, Dart, and Bun. Performance-first, type-safe infrastructure for AI and beyond."
      />
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <For each={category.items}>
                    {(tech) => (
                      <div class="group relative overflow-hidden rounded-2xl border border-gray-200/50 bg-white/90 backdrop-blur-sm transition-all hover:border-indigo-500 hover:shadow-xl dark:border-gray-700/50 dark:bg-gray-800/90">
                        {/* Icon Header */}
                        <div
                          class={`flex h-32 items-center justify-center bg-gradient-to-br ${tech.gradient}`}
                        >
                          <tech.icon class="h-12 w-12 text-white" stroke-width={1.5} />
                        </div>
          ...
          <div class="mx-auto mb-20 max-w-5xl">
            <div class="rounded-3xl border border-gray-200/50 bg-white/90 p-8 shadow-sm backdrop-blur-sm dark:border-gray-700/50 dark:bg-gray-800/90 md:p-12">
              ...
              <div class="space-y-6 text-lg text-gray-700 dark:text-gray-200">
                <p>
                ...
                <For each={[
                  ...
                  {(stat) => (
                    <div class="text-center">
                      <div class="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-500 to-purple-600">
